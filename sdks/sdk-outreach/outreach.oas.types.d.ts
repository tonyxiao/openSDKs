...
export interface paths {
  ...
  '/complianceRequests': {
     ...
     * @description This is a non-standard case please read [this section](/api/common-patterns/#create-compliance-requests)
     */
    post: {
      requestBody: {
        content: {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            'application/vnd.api+json': {
              data?: components['schemas']['orgSettingResponse']
            }
          }
        }
        /** @description Not Found */
    ...
    patch: {
      ...
      requestBody: {
        content: {
          'application/vnd.api+json': {
            data?: {
              attributes?: components['schemas']['orgSetting']
              /** @description As a UUID */
              id: string
              relationships?: components['schemas']['orgSettingRelationships']
              type: string
            }
          }
        }
...
export interface components {
  schemas: {
            ...
            [
              {
                data?: {
                  id?: number
                  /** @enum {string} */
                  type?: 'sequence' | 'snippet' | 'template'
                }
              },
              {
                links?: {
                  /** @enum {string} */
                  related?: 'sequence' | 'snippet' | 'template'
                }
              },
            ]
          >,
    ...
    messengerGroupRelationships: Record<string, never>
    ...
    /** @description The collection of settings for an Org. */
    orgSetting: {
      /**
       * @description
       *
       * Comma separated list of contact email addresses that are blocked.
       */
      contactExclusions?: string
      /**
       * @description
       *
       * Comma separated list of prospect email addresses blocked
       */
      prospectEmailExclusions?: string
      /**
       * @description
       *
       * Comma separated list of email addresses that are blocked
       */
      sendExclusions?: string
    }
            ...
            [
              {
                data?: {
                  id?: number
                  /** @enum {string} */
                  type?: 'sequenceStep' | 'stage' | 'user'
                }
              },
              {
                links?: {
                  /** @enum {string} */
                  related?: 'sequenceStep' | 'stage' | 'user'
                }
              },
            ]
          >,
