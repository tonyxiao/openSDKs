...
export interface components {
  schemas: {
    ...
    AccountingPeriod: {
      ...
      name?: string | null
      /** @example ACTIVE */
      status?: components['schemas']['AccountingPeriodStatusEnum'] | null
      /**
       * Format: date-time
     ...
     * @enum {string}
     */
    AccountingPeriodStatusEnum: 'ACTIVE' | 'INACTIVE'
    /**
    ...
    Invoice: {
       ...
       * ]
       */
      line_items?: readonly components['schemas']['InvoiceLineItem'][]
      remote_was_deleted?: boolean
      /**
       * Format: uuid
    ...
    JournalEntry: {
       ...
       * ]
       */
      lines?: readonly components['schemas']['JournalLine'][]
      /**
    ...
    PurchaseOrder: {
       ...
       * ]
       */
      line_items?: readonly components['schemas']['PurchaseOrderLineItem'][]
      /**
       * @example [
       *   "b38c59b0-a9d7-4740-b1ee-5436c6751e3d",
       *   "9b840d2-686a-465a-8a8e-7b028498f8e4",
    ...
    Transaction: {
       ...
       * ]
       */
      line_items?: readonly components['schemas']['TransactionLineItem'][]
      /** @description Indicates whether or not this object has been deleted in the third party platform. */
      remote_was_deleted?: boolean
      /**
       * Format: uuid
    ...
    VendorCredit: {
       ...
       * ]
       */
      lines?: readonly components['schemas']['VendorCreditLine'][]
      /**
       * @example [
       *   "b38c59b0-a9d7-4740-b1ee-5436c6751e3d",
       *   "9b840d2-686a-465a-8a8e-7b028498f8e4",
