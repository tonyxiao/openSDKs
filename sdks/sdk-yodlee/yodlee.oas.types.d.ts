...
export interface paths {
  ...
  '/consents/history/count': {
     ...
     */
    get: operations['getConsentHistoryCount']
  }
  '/providers/count': {
    /**
     * Get Providers Count
  ...
  '/providerAccounts/refresh': {
     ...
     */
    put: operations['refreshProviderAccount']
  }
...
export interface components {
  schemas: {
    ...
    ConsentHistoryResponse: {
      consentHistory?: readonly components['schemas']['ConsentHistory'][]
    }
    ...
    Providers: {
      ...
      betaContainers?: readonly string[]
      /**
       * Format: int64
    ...
    RefreshProviderAccountResponse: {
      statusLink?: readonly components['schemas']['StatusLink'][]
    }
    ...
    ConsentHistory: {
      ...
      deidentificationPreference?: boolean
      /** @description Consent start datetime. */
      startDateTime: string
      /**
       ...
       * @enum {string}
       */
      consentStatus: 'ACTIVE' | 'EXPIRED' | 'REVOKED' | 'CONSENT_REPEALED'
       ...
       */
      consentCollectionPeriod?: number
    }
    ...
    HoldingIdListResponse: {
      holding?: readonly components['schemas']['HoldingId'][]
    }
    /** ApiKeyResponse */
    ApiKeyResponse: {
    ...
    /** HoldingRequest */
    HoldingRequest: {
      holding: components['schemas']['HoldingRequestInfo'][]
    }
    /** ThirdPartyADR */
    ThirdPartyADR: {
    ...
    ConsentHistoryCountResponse: {
      consentHistory?: components['schemas']['ConsentHistoryCount']
    }
    /** Transaction */
    Transaction: {
      /** @description The value provided will be either postDate or transactionDate. postDate takes higher priority than transactionDate, except for the investment container as only transactionDate is available. The availability of postDate or transactionDate depends on the provider site.<br><br><b>Applicable containers</b>: bank,creditCard,investment,insurance,loan<br> */
...
export interface operations {
  ...
  getConsentHistoryCount: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json;charset=UTF-8': components['schemas']['ConsentHistoryCountResponse']
        }
      }
  ...
  getConsentHistory: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json;charset=UTF-8': components['schemas']['ConsentHistoryResponse']
        }
      }
  ...
  refreshProviderAccount: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ProviderAccountRefreshRequest']
      }
    }
    responses: {
      /** @description CREATED */
      201: {
        content: {
          'application/json;charset=UTF-8': components['schemas']['RefreshProviderAccountResponse']
        }
      }
  ...
  addHolding: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json;charset=UTF-8': components['schemas']['HoldingIdListResponse']
        }
      }
