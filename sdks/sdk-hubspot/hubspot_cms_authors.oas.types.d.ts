...
export interface paths {
  '/cms/v3/blogs/authors/{objectId}': {
     ...
     */
    get: operations['get-/cms/v3/blogs/authors/{objectId}_getById']
    /**
     * Delete a Blog Author
     * @description Delete the Blog Author object identified by the id in the path.
     */
    delete: operations['delete-/cms/v3/blogs/authors/{objectId}_archive']
    /**
     ...
     */
    patch: operations['patch-/cms/v3/blogs/authors/{objectId}_update']
  }
  '/cms/v3/blogs/authors/batch/update': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/batch/update_updateBatch']
  }
  '/cms/v3/blogs/authors/multi-language/detach-from-lang-group': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/multi-language/detach-from-lang-group_detachFromLangGroup']
  }
  '/cms/v3/blogs/authors/multi-language/set-new-lang-primary': {
     ...
     */
    put: operations['put-/cms/v3/blogs/authors/multi-language/set-new-lang-primary_setLangPrimary']
  }
  '/cms/v3/blogs/authors/batch/archive': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/batch/archive_archiveBatch']
  }
  '/cms/v3/blogs/authors/batch/create': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/batch/create_createBatch']
  }
  '/cms/v3/blogs/authors/batch/read': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/batch/read_readBatch']
  }
  '/cms/v3/blogs/authors': {
     ...
     */
    get: operations['get-/cms/v3/blogs/authors_getPage']
    /**
     * Create a new Blog Author
     * @description Create a new Blog Author.
     */
    post: operations['post-/cms/v3/blogs/authors_create']
  }
  '/cms/v3/blogs/authors/multi-language/attach-to-lang-group': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/multi-language/attach-to-lang-group_attachToLangGroup']
  }
  '/cms/v3/blogs/authors/multi-language/create-language-variation': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/multi-language/create-language-variation_createLangVariation']
  }
  '/cms/v3/blogs/authors/multi-language/update-languages': {
     ...
     */
    post: operations['post-/cms/v3/blogs/authors/multi-language/update-languages_updateLangs']
  }
}
...
export interface components {
  schemas: {
    ...
    BatchInputBlogAuthor: {
      ...
      inputs: components['schemas']['BlogAuthor'][]
    }
    ...
    BlogAuthorCloneRequestVNext: {
      ...
      blogAuthor: components['schemas']['BlogAuthor']
    }
    ...
    BatchResponseBlogAuthor: {
      ...
      results: components['schemas']['BlogAuthor'][]
      /**
...
export interface operations {
   ...
   * @description Retrieve the Blog Author object identified by the id in the path.
   */
  'get-/cms/v3/blogs/authors/{objectId}_getById': {
    parameters: {
      query?: {
   ...
   * @description Delete the Blog Author object identified by the id in the path.
   */
  'delete-/cms/v3/blogs/authors/{objectId}_archive': {
    parameters: {
      query?: {
   ...
   * All the column values need not be specified. Only the that need to be modified can be specified.
   */
  'patch-/cms/v3/blogs/authors/{objectId}_update': {
    parameters: {
      query?: {
   ...
   * @description Update the Blog Author objects identified in the request body.
   */
  'post-/cms/v3/blogs/authors/batch/update_updateBatch': {
    parameters: {
      query?: {
        /** @description Specifies whether to update deleted Blog Authors. Defaults to `false`. */
        archived?: boolean
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': components['schemas']['BatchResponseBlogAuthor']
        }
      }
      /** @description multiple statuses */
      207: {
        content: {
          'application/json': components['schemas']['BatchResponseBlogAuthorWithErrors']
        }
      }
      default: components['responses']['Error']
    }
   ...
   * @description Detach a Blog Author from a multi-language group.
   */
  'post-/cms/v3/blogs/authors/multi-language/detach-from-lang-group_detachFromLangGroup': {
   ...
   * @description Set a Blog Author as the primary language of a multi-language group.
   */
  'put-/cms/v3/blogs/authors/multi-language/set-new-lang-primary_setLangPrimary': {
   ...
   * @description Delete the Blog Author objects identified in the request body.
   */
  'post-/cms/v3/blogs/authors/batch/archive_archiveBatch': {
   ...
   * @description Create the Blog Author objects detailed in the request body.
   */
  'post-/cms/v3/blogs/authors/batch/create_createBatch': {
    /** @description The JSON array of new Blog Authors to create. */
    requestBody: {
      content: {
        'application/json': components['schemas']['BatchInputBlogAuthor']
      }
    }
    responses: {
      /** @description successful operation */
   ...
   * @description Retrieve the Blog Author objects identified in the request body.
   */
  'post-/cms/v3/blogs/authors/batch/read_readBatch': {
    parameters: {
      query?: {
        /** @description Specifies whether to return deleted Blog Authors. Defaults to `false`. */
        archived?: boolean
   ...
   * @description Get the list of blog authors. Supports paging and filtering. This method would be useful for an integration that examined these models and used an external service to suggest edits.
   */
  'get-/cms/v3/blogs/authors_getPage': {
    parameters: {
      query?: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': components['schemas']['CollectionResponseWithTotalBlogAuthorForwardPaging']
        }
      }
      default: components['responses']['Error']
    }
   ...
   * @description Create a new Blog Author.
   */
  'post-/cms/v3/blogs/authors_create': {
   ...
   * @description Attach a Blog Author to a multi-language group.
   */
  'post-/cms/v3/blogs/authors/multi-language/attach-to-lang-group_attachToLangGroup': {
   ...
   * @description Create a new language variation from an existing Blog Author.
   */
  'post-/cms/v3/blogs/authors/multi-language/create-language-variation_createLangVariation': {
    /** @description The JSON representation of the ContentLanguageCloneRequest object. */
    requestBody: {
      content: {
        'application/json': components['schemas']['BlogAuthorCloneRequestVNext']
      }
    }
    responses: {
      /** @description successful operation */
   ...
   * @description Explicitly set new languages for each Blog Author in a multi-language group.
   */
  'post-/cms/v3/blogs/authors/multi-language/update-languages_updateLangs': {
