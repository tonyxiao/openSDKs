...
export interface paths {
  '/crm/v3/objects/deals/batch/read': {
    ...
    post: operations['post-/crm/v3/objects/deals/batch/read_read']
  }
  '/crm/v3/objects/deals/{dealId}': {
     ...
     */
    get: operations['get-/crm/v3/objects/deals/{dealId}_getById']
    /**
     * Archive
     * @description Move an Object identified by `{dealId}` to the recycling bin.
     */
    delete: operations['delete-/crm/v3/objects/deals/{dealId}_archive']
    /**
     * Update
     ...
     */
    patch: operations['patch-/crm/v3/objects/deals/{dealId}_update']
  }
  '/crm/v3/objects/deals/merge': {
    /** Merge two deals with same type */
    post: operations['post-/crm/v3/objects/deals/merge_merge']
  }
  '/crm/v3/objects/deals/batch/archive': {
    /** Archive a batch of deals by ID */
    post: operations['post-/crm/v3/objects/deals/batch/archive_archive']
  }
  '/crm/v3/objects/deals/batch/create': {
    /** Create a batch of deals */
    post: operations['post-/crm/v3/objects/deals/batch/create_create']
  }
  '/crm/v3/objects/deals/batch/update': {
    /** Update a batch of deals */
    post: operations['post-/crm/v3/objects/deals/batch/update_update']
  }
  '/crm/v3/objects/deals/gdpr-delete': {
     ...
     */
    post: operations['post-/crm/v3/objects/deals/gdpr-delete_purge']
  }
  '/crm/v3/objects/deals': {
     ...
     */
    get: operations['get-/crm/v3/objects/deals_getPage']
    /**
     * Create
     ...
     */
    post: operations['post-/crm/v3/objects/deals_create']
  }
  '/crm/v3/objects/deals/search': {
    post: operations['post-/crm/v3/objects/deals/search_doSearch']
  }
}
...
export interface operations {
  /** Read a batch of deals by internal ID, or unique property values */
  'post-/crm/v3/objects/deals/batch/read_read': {
    parameters: {
      query?: {
   ...
   * @description Move an Object identified by `{dealId}` to the recycling bin.
   */
  'delete-/crm/v3/objects/deals/{dealId}_archive': {
    parameters: {
      path: {
        dealId: string
      }
   ...
   * @description Perform a partial update of an Object identified by `{dealId}`. `{dealId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
   */
  'patch-/crm/v3/objects/deals/{dealId}_update': {
    parameters: {
      query?: {
        /** @description The name of a property whose values are unique for this object type */
        idProperty?: string
  ...
  /** Merge two deals with same type */
  'post-/crm/v3/objects/deals/merge_merge': {
    requestBody: {
      content: {
  ...
  /** Archive a batch of deals by ID */
  'post-/crm/v3/objects/deals/batch/archive_archive': {
    requestBody: {
      content: {
  ...
  /** Create a batch of deals */
  'post-/crm/v3/objects/deals/batch/create_create': {
    requestBody: {
      content: {
  ...
  /** Update a batch of deals */
  'post-/crm/v3/objects/deals/batch/update_update': {
    requestBody: {
      content: {
   ...
   * @description Permanently delete a contact and all associated content to follow GDPR. Use optional property 'idProperty' set to 'email' to identify contact by email address. If email address is not found, the email address will be added to a blocklist and prevent it from being used in the future.
   */
  'post-/crm/v3/objects/deals/gdpr-delete_purge': {
    requestBody: {
      content: {
