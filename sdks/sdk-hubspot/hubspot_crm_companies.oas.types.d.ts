...
export interface paths {
  '/crm/v3/objects/companies/batch/read': {
    ...
    post: operations['post-/crm/v3/objects/companies/batch/read_read']
  }
  '/crm/v3/objects/companies/{companyId}': {
     ...
     */
    get: operations['get-/crm/v3/objects/companies/{companyId}_getById']
    /**
     * Archive
     * @description Move an Object identified by `{companyId}` to the recycling bin.
     */
    delete: operations['delete-/crm/v3/objects/companies/{companyId}_archive']
    /**
     * Update
     ...
     */
    patch: operations['patch-/crm/v3/objects/companies/{companyId}_update']
  }
  '/crm/v3/objects/companies/merge': {
    /** Merge two companies with same type */
    post: operations['post-/crm/v3/objects/companies/merge_merge']
  }
  '/crm/v3/objects/companies/batch/archive': {
    /** Archive a batch of companies by ID */
    post: operations['post-/crm/v3/objects/companies/batch/archive_archive']
  }
  '/crm/v3/objects/companies/batch/create': {
    /** Create a batch of companies */
    post: operations['post-/crm/v3/objects/companies/batch/create_create']
  }
  '/crm/v3/objects/companies/batch/update': {
    /** Update a batch of companies */
    post: operations['post-/crm/v3/objects/companies/batch/update_update']
  }
  '/crm/v3/objects/companies/gdpr-delete': {
     ...
     */
    post: operations['post-/crm/v3/objects/companies/gdpr-delete_purge']
  }
  '/crm/v3/objects/companies': {
     ...
     */
    get: operations['get-/crm/v3/objects/companies_getPage']
    /**
     * Create
     ...
     */
    post: operations['post-/crm/v3/objects/companies_create']
  }
  '/crm/v3/objects/companies/search': {
    post: operations['post-/crm/v3/objects/companies/search_doSearch']
  }
}
...
export interface operations {
  /** Read a batch of companies by internal ID, or unique property values */
  'post-/crm/v3/objects/companies/batch/read_read': {
    parameters: {
      query?: {
   ...
   * @description Read an Object identified by `{companyId}`. `{companyId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param.  Control what is returned via the `properties` query param.
   */
  'get-/crm/v3/objects/companies/{companyId}_getById': {
    parameters: {
      query?: {
   ...
   * @description Perform a partial update of an Object identified by `{companyId}`. `{companyId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
   */
  'patch-/crm/v3/objects/companies/{companyId}_update': {
    parameters: {
      query?: {
        /** @description The name of a property whose values are unique for this object type */
        idProperty?: string
  ...
  /** Merge two companies with same type */
  'post-/crm/v3/objects/companies/merge_merge': {
    requestBody: {
      content: {
  ...
  /** Archive a batch of companies by ID */
  'post-/crm/v3/objects/companies/batch/archive_archive': {
    requestBody: {
      content: {
  ...
  /** Create a batch of companies */
  'post-/crm/v3/objects/companies/batch/create_create': {
    requestBody: {
      content: {
  ...
  /** Update a batch of companies */
  'post-/crm/v3/objects/companies/batch/update_update': {
    requestBody: {
      content: {
   ...
   * @description Permanently delete a contact and all associated content to follow GDPR. Use optional property 'idProperty' set to 'email' to identify contact by email address. If email address is not found, the email address will be added to a blocklist and prevent it from being used in the future.
   */
  'post-/crm/v3/objects/companies/gdpr-delete_purge': {
    requestBody: {
      content: {
