...
export interface paths {
  '/crm/v3/objects/products/batch/read': {
    ...
    post: operations['post-/crm/v3/objects/products/batch/read_read']
  }
  '/crm/v3/objects/products/{productId}': {
     ...
     */
    get: operations['get-/crm/v3/objects/products/{productId}_getById']
    /**
     * Archive
     * @description Move an Object identified by `{productId}` to the recycling bin.
     */
    delete: operations['delete-/crm/v3/objects/products/{productId}_archive']
    /**
     * Update
     ...
     */
    patch: operations['patch-/crm/v3/objects/products/{productId}_update']
  }
  '/crm/v3/objects/products/merge': {
    /** Merge two products with same type */
    post: operations['post-/crm/v3/objects/products/merge']
  }
  '/crm/v3/objects/products/batch/archive': {
    /** Archive a batch of products by ID */
    post: operations['post-/crm/v3/objects/products/batch/archive_archive']
  }
  '/crm/v3/objects/products/batch/create': {
    /** Create a batch of products */
    post: operations['post-/crm/v3/objects/products/batch/create_create']
  }
  '/crm/v3/objects/products/batch/update': {
    /** Update a batch of products */
    post: operations['post-/crm/v3/objects/products/batch/update_update']
  }
  '/crm/v3/objects/products/gdpr-delete': {
     ...
     */
    post: operations['post-/crm/v3/objects/products/gdpr-delete_purge']
  }
  '/crm/v3/objects/products': {
     ...
     */
    get: operations['get-/crm/v3/objects/products_getPage']
    /**
     * Create
     ...
     */
    post: operations['post-/crm/v3/objects/products_create']
  }
  '/crm/v3/objects/products/search': {
    post: operations['post-/crm/v3/objects/products/search_doSearch']
  }
}
...
export interface operations {
  /** Read a batch of products by internal ID, or unique property values */
  'post-/crm/v3/objects/products/batch/read_read': {
    parameters: {
      query?: {
   ...
   * @description Read an Object identified by `{productId}`. `{productId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param.  Control what is returned via the `properties` query param.
   */
  'get-/crm/v3/objects/products/{productId}_getById': {
    parameters: {
      query?: {
   ...
   * @description Move an Object identified by `{productId}` to the recycling bin.
   */
  'delete-/crm/v3/objects/products/{productId}_archive': {
    parameters: {
      path: {
        productId: string
      }
   ...
   * @description Perform a partial update of an Object identified by `{productId}`. `{productId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
   */
  'patch-/crm/v3/objects/products/{productId}_update': {
    parameters: {
      query?: {
        /** @description The name of a property whose values are unique for this object type */
        idProperty?: string
  ...
  /** Archive a batch of products by ID */
  'post-/crm/v3/objects/products/batch/archive_archive': {
    requestBody: {
      content: {
  ...
  /** Create a batch of products */
  'post-/crm/v3/objects/products/batch/create_create': {
    requestBody: {
      content: {
  ...
  /** Update a batch of products */
  'post-/crm/v3/objects/products/batch/update_update': {
    requestBody: {
      content: {
   ...
   * @description Permanently delete a contact and all associated content to follow GDPR. Use optional property 'idProperty' set to 'email' to identify contact by email address. If email address is not found, the email address will be added to a blocklist and prevent it from being used in the future.
   */
  'post-/crm/v3/objects/products/gdpr-delete_purge': {
    requestBody: {
      content: {
