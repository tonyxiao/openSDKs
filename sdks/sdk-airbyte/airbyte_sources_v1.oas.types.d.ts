...
export interface components {
  schemas: {
    ...
    'source-stripe': {
      ...
      num_workers?: number
      /**
       * Max number of API calls per second
    ...
    'source-jira': {
      ...
      /**
       * Expand Issue Transitions
       * @description (DEPRECATED) Expand the transitions when replicating issues.
       * @default false
       */
      expand_issue_transition?: boolean
      /**
       * Expand Issues stream
     ...
     */
    SourceConfiguration:
      | components['schemas']['source-aha']
      | components['schemas']['source-aircall']
      | components['schemas']['source-airtable']
      | components['schemas']['source-alloydb']
      | components['schemas']['source-amazon-ads']
      | components['schemas']['source-amazon-seller-partner']
      | components['schemas']['source-amazon-sqs']
      | components['schemas']['source-amplitude']
      | components['schemas']['source-apify-dataset']
      | components['schemas']['source-appfollow']
      | components['schemas']['source-asana']
      | components['schemas']['source-auth0']
      | components['schemas']['source-aws-cloudtrail']
      | components['schemas']['source-azure-blob-storage']
      | components['schemas']['source-azure-table']
      | components['schemas']['source-bamboo-hr']
      | components['schemas']['source-bigquery']
      | components['schemas']['source-bing-ads']
      | components['schemas']['source-braintree']
      | components['schemas']['source-braze']
      | components['schemas']['source-cart']
      | components['schemas']['source-chargebee']
      | components['schemas']['source-chartmogul']
      | components['schemas']['source-clickhouse']
      | components['schemas']['source-clickup-api']
      | components['schemas']['source-clockify']
      | components['schemas']['source-close-com']
      | components['schemas']['source-coda']
      | components['schemas']['source-coin-api']
      | components['schemas']['source-coinmarketcap']
      | components['schemas']['source-configcat']
      | components['schemas']['source-confluence']
      | components['schemas']['source-convex']
      | components['schemas']['source-datascope']
      | components['schemas']['source-delighted']
      | components['schemas']['source-dixa']
      | components['schemas']['source-dockerhub']
      | components['schemas']['source-dremio']
      | components['schemas']['source-dynamodb']
      | components['schemas']['source-e2e-test-cloud']
      | components['schemas']['source-emailoctopus']
      | components['schemas']['source-exchange-rates']
      | components['schemas']['source-facebook-marketing']
      | components['schemas']['source-faker']
      | components['schemas']['source-fauna']
      | components['schemas']['source-file']
      | components['schemas']['source-firebolt']
      | components['schemas']['source-freshcaller']
      | components['schemas']['source-freshdesk']
      | components['schemas']['source-freshsales']
      | components['schemas']['source-gainsight-px']
      | components['schemas']['source-gcs']
      | components['schemas']['source-getlago']
      | components['schemas']['source-github']
      | components['schemas']['source-gitlab']
      | components['schemas']['source-glassfrog']
      | components['schemas']['source-gnews']
      | components['schemas']['source-google-ads']
      | components['schemas']['source-google-analytics-data-api']
      | components['schemas']['source-google-directory']
      | components['schemas']['source-google-drive']
      | components['schemas']['source-google-pagespeed-insights']
      | components['schemas']['source-google-search-console']
      | components['schemas']['source-google-sheets']
      | components['schemas']['source-google-webfonts']
      | components['schemas']['source-google-workspace-admin-reports']
      | components['schemas']['source-greenhouse']
      | components['schemas']['source-gridly']
      | components['schemas']['source-harvest']
      | components['schemas']['source-hubplanner']
      | components['schemas']['source-hubspot']
      | components['schemas']['source-insightly']
      | components['schemas']['source-instagram']
      | components['schemas']['source-instatus']
      | components['schemas']['source-intercom']
      | components['schemas']['source-ip2whois']
      | components['schemas']['source-iterable']
      | components['schemas']['source-jira']
      | components['schemas']['source-k6-cloud']
      | components['schemas']['source-klarna']
      | components['schemas']['source-klaviyo']
      | components['schemas']['source-kustomer-singer']
      | components['schemas']['source-kyve']
      | components['schemas']['source-launchdarkly']
      | components['schemas']['source-lemlist']
      | components['schemas']['source-lever-hiring']
      | components['schemas']['source-linkedin-ads']
      | components['schemas']['source-linkedin-pages']
      | components['schemas']['source-linnworks']
      | components['schemas']['source-lokalise']
      | components['schemas']['source-mailchimp']
      | components['schemas']['source-mailgun']
      | components['schemas']['source-mailjet-sms']
      | components['schemas']['source-marketo']
      | components['schemas']['source-metabase']
      | components['schemas']['source-microsoft-teams']
      | components['schemas']['source-mixpanel']
      | components['schemas']['source-monday']
      | components['schemas']['source-mongodb-internal-poc']
      | components['schemas']['source-mongodb-v2']
      | components['schemas']['source-mssql']
      | components['schemas']['source-my-hours']
      | components['schemas']['source-mysql']
      | components['schemas']['source-netsuite']
      | components['schemas']['source-notion']
      | components['schemas']['source-nytimes']
      | components['schemas']['source-okta']
      | components['schemas']['source-omnisend']
      | components['schemas']['source-onesignal']
      | components['schemas']['source-oracle']
      | components['schemas']['source-orb']
      | components['schemas']['source-orbit']
      | components['schemas']['source-outbrain-amplify']
      | components['schemas']['source-outreach']
      | components['schemas']['source-paypal-transaction']
      | components['schemas']['source-paystack']
      | components['schemas']['source-pendo']
      | components['schemas']['source-persistiq']
      | components['schemas']['source-pexels-api']
      | components['schemas']['source-pinterest']
      | components['schemas']['source-pipedrive']
      | components['schemas']['source-pocket']
      | components['schemas']['source-pokeapi']
      | components['schemas']['source-polygon-stock-api']
      | components['schemas']['source-postgres']
      | components['schemas']['source-posthog']
      | components['schemas']['source-postmarkapp']
      | components['schemas']['source-prestashop']
      | components['schemas']['source-punk-api']
      | components['schemas']['source-pypi']
      | components['schemas']['source-qualaroo']
      | components['schemas']['source-quickbooks']
      | components['schemas']['source-railz']
      | components['schemas']['source-recharge']
      | components['schemas']['source-recreation']
      | components['schemas']['source-recruitee']
      | components['schemas']['source-recurly']
      | components['schemas']['source-redshift']
      | components['schemas']['source-retently']
      | components['schemas']['source-rki-covid']
      | components['schemas']['source-rss']
      | components['schemas']['source-s3']
      | components['schemas']['source-salesforce']
      | components['schemas']['source-salesloft']
      | components['schemas']['source-sap-fieldglass']
      | components['schemas']['source-secoda']
      | components['schemas']['source-sendgrid']
      | components['schemas']['source-sendinblue']
      | components['schemas']['source-senseforce']
      | components['schemas']['source-sentry']
      | components['schemas']['source-sftp']
      | components['schemas']['source-sftp-bulk']
      | components['schemas']['source-shopify']
      | components['schemas']['source-shortio']
      | components['schemas']['source-slack']
      | components['schemas']['source-smaily']
      | components['schemas']['source-smartengage']
      | components['schemas']['source-smartsheets']
      | components['schemas']['source-snapchat-marketing']
      | components['schemas']['source-snowflake']
      | components['schemas']['source-sonar-cloud']
      | components['schemas']['source-spacex-api']
      | components['schemas']['source-square']
      | components['schemas']['source-strava']
      | components['schemas']['source-stripe']
      | components['schemas']['source-survey-sparrow']
      | components['schemas']['source-surveymonkey']
      | components['schemas']['source-tempo']
      | components['schemas']['source-the-guardian-api']
      | components['schemas']['source-tiktok-marketing']
      | components['schemas']['source-trello']
      | components['schemas']['source-trustpilot']
      | components['schemas']['source-tvmaze-schedule']
      | components['schemas']['source-twilio']
      | components['schemas']['source-twilio-taskrouter']
      | components['schemas']['source-twitter']
      | components['schemas']['source-typeform']
      | components['schemas']['source-us-census']
      | components['schemas']['source-vantage']
      | components['schemas']['source-webflow']
      | components['schemas']['source-whisky-hunter']
      | components['schemas']['source-wikipedia-pageviews']
      | components['schemas']['source-woocommerce']
      | components['schemas']['source-xkcd']
      | components['schemas']['source-yandex-metrica']
      | components['schemas']['source-yotpo']
      | components['schemas']['source-youtube-analytics']
      | components['schemas']['source-zendesk-chat']
      | components['schemas']['source-zendesk-sell']
      | components['schemas']['source-zendesk-sunshine']
      | components['schemas']['source-zendesk-support']
      | components['schemas']['source-zendesk-talk']
      | components['schemas']['source-zenloop']
      | components['schemas']['source-zoho-crm']
      | components['schemas']['source-zoom']
      | components['schemas']['source-zuora']
    /**
